...
public class AddAgreementItem {

	public static String agreementItem_id = null, agreementItem_itemDurationEndDateTime = null,
			agreementItem_itemDurationStartDateTime = null, agreementItem_itemDurationAmount = null,
			agreementItem_itemDurationUnits = null, agreementItem_incentiveServiceCode = null,
			agreementItem_itemType = null, agreementItem_incentiveAmount = null,
			agreementItem_installmentEndDateTime = null, agreementItem_installmentStartDateTime = null,
			agreementItem_installmentAmount = null, agreementItem_installmentUnits = null,
			agreementItem_installmentLeftNum = null, agreementItem_installmentLeftNumValue = null,
			agreementItem_installmentAppliedNum = null, agreementItem_installmentAppliedNumValue = null,
			agreementItem_installmentAppliedAmt = null, agreementItem_installmentAppliedAmtValue = null,
			agreementItem_termOrConditionMinRatePlan = null, agreementItem_termOrConditionMinRatePlanValue = null,
			agreementItem_termOrConditionMinFeature = null, agreementItem_termOrConditionMinFeatureValue = null,
			agreementItem_termOrConditionMinCombined = null, agreementItem_termOrConditionMinCombinedValue = null,
			agreementItem_termOrConditionCommitmentServiceCd = null,
			agreementItem_termOrConditionCommitmentServiceCdValue = null,
			agreementItem_termOrConditionAutoTopupCommitmentInd = null,
			agreementItem_termOrConditionAutoTopupCommitmentIndValue = null, agreementItem_tax = null,
			agreementItem_taxPaymentMethodCode = null, agreementItem_taxPaymentMechanismCode = null,
			agreementItem_taxPaymentChannelCode = null, agreementItem_taxProvinceCode = null,
			agreementItem_taxCategory = null, agreementItem_taxRate = null, agreementItem_taxAmountValue = null,
			agreementItem_taxAmountUnit = null, agreementItem_product = null, agreementItem_productSerialNumber = null,
			agreementItem_productSpecificationid = null, agreementItem_productSpecificationCategoryCode = null,
			agreementItem_productSpecificationLocale1 = null, agreementItem_productSpecificationDesc1 = null,
			agreementItem_productSpecificationLocale2 = null, agreementItem_productSpecificationDesc2 = null,
			agreementItem_productSpecificationTypeCode = null, agreementItem_productPriceValue = null,
			agreementItem_productPriceUnit = null, agreementItem_productCharacteristicName = null,
			agreementItem_productCharacteristicValue = null, agreementItem_promotionid = null,
			agreementItem_promotionPerspectiveDate = null, agreementItem_productOfferingid = null,
			agreementItem_productOfferingRedeemedOfferContextCode = null,
			agreementItem_productOfferingRedeemedOfferContextCodeValue = null,
			agreementItem_productOfferingOfferTierCd = null, agreementItem_productOfferingOfferTierCdValue = null,
			agreementItem_productOfferingOfferTierCapAmt = null,
			agreementItem_productOfferingOfferTierCapAmtValue = null,
			agreementItem_productOfferingDataCommitmentInd = null,
			agreementItem_productOfferingDataCommitmentIndValue = null,
			agreementItem_productOfferingContractEnforcedPlanInd = null,
			agreementItem_productOfferingContractEnforcedPlanIndValue = null,
			agreementItem_productOfferingPerspectiveDate = null, agreementItem_productOfferingSourceSystemId = null,
			agreementItem_relatedPartyId = null, agreementItem_relatedPartyRole = null,
			agreementItem_relatedPartySourceSystemId = null;
	...
	public AddAgreementItem(int i) {
		...
		agreementItem_installmentStartDateTime = "$.agreementItem[" + i
				+ "].installment.installmentDuration.startDateTime";
		...
		agreementItem_termOrConditionMinRatePlanValue = "$.agreementItem[" + i
				+ "].termOrCondition.characteristic[0].value";

		agreementItem_termOrConditionMinFeature = "$.agreementItem[" + i + "].termOrCondition.characteristic[1].name";
		agreementItem_termOrConditionMinFeatureValue = "$.agreementItem[" + i
				+ "].termOrCondition.characteristic[1].value";

		agreementItem_termOrConditionMinCombined = "$.agreementItem[" + i + "].termOrCondition.characteristic[2].name";
		agreementItem_termOrConditionMinCombinedValue = "$.agreementItem[" + i
				+ "].termOrCondition.characteristic[2].value";

		agreementItem_termOrConditionCommitmentServiceCd = "$.agreementItem[" + i
				+ "].termOrCondition.characteristic[3].name";
		agreementItem_termOrConditionCommitmentServiceCdValue = "$.agreementItem[" + i
				+ "].termOrCondition.characteristic[3].value";

		agreementItem_termOrConditionAutoTopupCommitmentInd = "$.agreementItem[" + i
				+ "].termOrCondition.characteristic[4].name";
		agreementItem_termOrConditionAutoTopupCommitmentIndValue = "$.agreementItem[" + i
		...
		agreementItem_productSpecificationCategoryCode = "$.agreementItem[" + i
				+ "].product[0].productSpecification.categoryCode";
		agreementItem_productSpecificationLocale1 = "$.agreementItem[" + i
				+ "].product[0].productSpecification.description[0].locale";
		agreementItem_productSpecificationDesc1 = "$.agreementItem[" + i
				+ "].product[0].productSpecification.description[0].description";
		agreementItem_productSpecificationLocale2 = "$.agreementItem[" + i
				+ "].product[0].productSpecification.description[1].locale";
		agreementItem_productSpecificationDesc2 = "$.agreementItem[" + i
				+ "].product[0].productSpecification.description[1].description";

		agreementItem_productSpecificationTypeCode = "$.agreementItem[" + i
				+ "].product[0].productSpecification.typeCode";
		agreementItem_productPriceValue = "$.agreementItem[" + i
				+ "].product[0].productPrice.price.dutyFreeAmount.value";
		...
		agreementItem_productCharacteristicValue = "$.agreementItem[" + i
				+ "].product[0].productCharacteristic[0].value";
		...
		agreementItem_productOfferingRedeemedOfferContextCode = "$.agreementItem[" + i
				+ "].productOffering.characteristic[0].name";
		agreementItem_productOfferingRedeemedOfferContextCodeValue = "$.agreementItem[" + i
		...
		agreementItem_productOfferingOfferTierCdValue = "$.agreementItem[" + i
				+ "].productOffering.characteristic[1].value";

		agreementItem_productOfferingOfferTierCapAmt = "$.agreementItem[" + i
				+ "].productOffering.characteristic[2].name";
		agreementItem_productOfferingOfferTierCapAmtValue = "$.agreementItem[" + i
				+ "].productOffering.characteristic[2].value";

		agreementItem_productOfferingDataCommitmentInd = "$.agreementItem[" + i
				+ "].productOffering.characteristic[3].name";
		agreementItem_productOfferingDataCommitmentIndValue = "$.agreementItem[" + i
				+ "].productOffering.characteristic[3].value";

		agreementItem_productOfferingContractEnforcedPlanInd = "$.agreementItem[" + i
				+ "].productOffering.characteristic[4].name";
		agreementItem_productOfferingContractEnforcedPlanIndValue = "$.agreementItem[" + i
