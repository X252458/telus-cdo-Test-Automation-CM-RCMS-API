...
public class TC06_Telus_DB_DF_BIB_Renewal_DB_Pay_BIB_TRADE_PENDING_LOG_Event_UPDATE_DUEDATE extends BaseTest {
	...
	@Test(groups = {"Loyalty_Management","logEvent", "TC06_Telus_DB_DF_BIB_Renewal_DB_Pay_BIB_TRADE_PENDING_LOG_Event_UPDATE_DUEDATE",
	...
	public void testMethod_Termination(ITestContext iTestContext) throws Exception {
		...
		Map<String, Object> apiOperation3 = GenericUtils.featureFileFailLoop_status(environment,
				"classpath:tests/RCMS/LogEvent/LogEventTC6.feature","apiDetailsStatus","201");
		Reporting.logReporter(Status.INFO, 
