...
public class TC04_Telus_DB_DF_BIB_Renewal_DB_Pay_BIB_TRADE_PENDING_LOG_Event_CHARGE_COMPLETE extends BaseTest {
	...
	@Test(groups = {"Loyalty_Management","logEvent", "TC04_Telus_DB_DF_BIB_Renewal_DB_Pay_BIB_TRADE_PENDING_LOG_Event_CHARGE_COMPLETE",
	...
	public void testMethod_Termination(ITestContext iTestContext) throws Exception {
		...
		// LogEvent API Call
		Reporting.setNewGroupName("LOG EVENT CHARGE_COMPLETE API CALL");
		Reporting.logReporter(Status.INFO, "API Test Env is : [" + apiEnv + "]");

		Map<String, Object> apiOperation3 = GenericUtils.featureFileFailLoop_status(environment,
				"classpath:tests/RCMS/LogEvent/LogEventTC4.feature","apiDetailsStatus","201");
		Reporting.logReporter(Status.INFO, 
