...
public class TC02_Telus_DB_DF_BIB_Renewal_DB_Pay_BIB_TRADE_PENDING_LOG_Event_RETURN_COMPLETE extends BaseTest {
	...
	@Test(groups = {"Loyalty_Management","logEvent", "TC02_Telus_DB_DF_BIB_Renewal_DB_Pay_BIB_TRADE_PENDING_LOG_Event_RETURN_COMPLETE",
	...
	public void testMethod_Termination(ITestContext iTestContext) throws Exception {
		...
		Map<String, Object> apiOperation3 = GenericUtils.featureFileFailLoop_status(environment,
				"classpath:tests/RCMS/LogEvent/LogEventTC2.feature","apiDetailsStatus","201");
		Reporting.logReporter(Status.INFO, 
