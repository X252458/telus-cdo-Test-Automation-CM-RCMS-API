...
public class TC05_Telus_DB_ACB_TIA_TIP_DF_ExAgItem extends BaseTest {
	...
	@Test(groups = { "ExchangeAgreementItem","TC05_Telus_DB_ACB_TIA_TIP_DF_ExAgItem","CompleteRegressionSuite" ,"LoyaltyAgreementServices"})
	...
	public void testMethod_Migration(ITestContext iTestContext) throws Exception {
		...
		Map<String, Object> apiOperation1 = GenericUtils.featureFileFailLoop_status(environment,
				"classpath:tests/RCMS/Activation/Others/activationTC19.feature","apiStatus","200");
		Reporting.logReporter(Status.INFO,
		...
		Map<String, Object> apiOperation2 = GenericUtils.featureFileFailLoop_status(environment,
				"classpath:tests/RCMS/ExchangeAgreementItem/ExchangeAgreementItemTC5.feature","apiDetailsStatus","500");
		Reporting.logReporter(Status.INFO,
		...
		Reporting.logReporter(Status.INFO, "Expected http response is 500 because Exchange not possible as AF doesnt exist");
		Reporting.printAndClearLogGroupStatements();
