...
public class TC02_Telus_DF_DB_ExAgmtItem extends BaseTest {
	...
	@Test(groups = { "ExchangeAgreementItem","TC02_Telus_DF_DB_ExAgmtItem","CompleteRegressionSuite","LoyaltyAgreementServices" })
	...
	public void testMethod_Migration(ITestContext iTestContext) throws Exception {
		...
		Reporting.logReporter(Status.INFO, "Expected http response is 500 because AF is not Available in Rewards");
		Reporting.printAndClearLogGroupStatements();
