...
public class TC01_Telus_DB_TIA_AF_ExAgmtItem extends BaseTest {
	...
	@Test(groups = { "ExchangeAgreementItem","TC01_Telus_DB_TIA_AF_ExAgmtItem","CompleteRegressionSuite","LoyaltyAgreementServices" })
	...
	public void testMethod_Migration(ITestContext iTestContext) throws Exception {
		...
		Map<String, Object> apiOperation2 = GenericUtils.featureFileFailLoop_status(environment,
				"classpath:tests/RCMS/ExchangeAgreementItem/ExchangeAgreementItemTC1.feature","apiDetailsStatus","200");
		Reporting.logReporter(Status.INFO,
