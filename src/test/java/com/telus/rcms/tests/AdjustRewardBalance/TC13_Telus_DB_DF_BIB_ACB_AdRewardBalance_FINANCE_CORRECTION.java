...
public class TC13_Telus_DB_DF_BIB_ACB_AdRewardBalance_FINANCE_CORRECTION extends BaseTest {
	...
	public void testMethod_Termination(ITestContext iTestContext) throws Exception {
		...
		Map<String, Object> apiOperation1 = GenericUtils.featureFileFailLoop_status(environment,
				...
				"tc07ActivateTelusSubwithDF_DB_BIB_ACBStatus","200");
		Reporting.logReporter(Status.INFO,
		...
		Map<String, Object> apiOperation2 = GenericUtils.featureFileFailLoop_status(environment,
				"classpath:tests/RCMS/AdjustRewardBalance/AdjustRewardBalanceTC13.feature", "apiDetailsStatus","200");
