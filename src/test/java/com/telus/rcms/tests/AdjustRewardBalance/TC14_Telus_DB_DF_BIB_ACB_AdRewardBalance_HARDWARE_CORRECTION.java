...
public class TC14_Telus_DB_DF_BIB_ACB_AdRewardBalance_HARDWARE_CORRECTION  extends BaseTest {
	...
	@Test(groups = {"Loyalty_Management","Adjust_Reward_Balance","TC14_Telus_DB_DF_BIB_ACB_AdRewardBalance_HARDWARE_CORRECTION","CompleteRegressionSuite"})
	...
	public void testMethod_Termination(ITestContext iTestContext) throws Exception {
		...
		// Adjust Reward Balance API Call to Make DF balance 0.
				...
				Reporting.setNewGroupName("ADJUST REWARD BALANCE API CALL - DB+DF+BIB+ACB_Adjust_DB");
				Reporting.logReporter(Status.INFO, "API Test Env is : [" + apiEnv + "]");

				System.setProperty("karate.itemType","HARDWARE");
				
				Map<String, Object> apiOperation2 = GenericUtils.featureFileFailLoop_status(environment,"classpath:tests/RCMS/AdjustRewardBalance/AdjustRewardBalanceTC14.feature","apiDetailsStatus","200");
				Reporting.logReporter(Status.INFO,
		...
		Reporting.setNewGroupName("ADJUST REWARD BALANCE API CALL - DB+DF+BIB+ACB_DB_Correction");
		Reporting.logReporter(Status.INFO, "API Test Env is : [" + apiEnv + "]");

		Map<String, Object> apiOperation3 = GenericUtils.featureFileFailLoop_status(environment,"classpath:tests/RCMS/AdjustRewardBalance/AdjustRewardBalanceTC14.feature","apiDetailsStatus","200");
		Reporting.logReporter(Status.INFO,
	...
	public void payloadAndDbCheck() throws SQLException, IOException {
		...
		GenericUtils.responseDBCheckAdjustRewardBalance(jsonString, balanceAmount,1);
