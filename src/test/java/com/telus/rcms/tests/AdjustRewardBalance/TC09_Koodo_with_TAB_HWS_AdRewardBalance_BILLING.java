...
public class TC09_Koodo_with_TAB_HWS_AdRewardBalance_BILLING extends BaseTest {
	...
	@Test(groups = {"Loyalty_Management","Adjust_Reward_Balance","TC09_Koodo_with_TAB_HWS_AdRewardBalance_BILLING","CompleteRegressionSuite" })
	...
	public void testMethod_Activation(ITestContext iTestContext) throws Exception {
		...
		Reporting.setNewGroupName("ADJUST REWARD BALANCE API CALL - TAB_RETAIL ");
		Reporting.logReporter(Status.INFO, "API Test Env is : [" + apiEnv + "]");
		
		System.setProperty("karate.itemType","TAB");
		
		Map<String, Object> apiOperation2 = GenericUtils.featureFileFailLoop_status(environment,"classpath:tests/RCMS/AdjustRewardBalance/AdjustRewardBalanceTC9.feature","apiDetailsStatus","200");
		Reporting.logReporter(Status.INFO,
		...
		Reporting.setNewGroupName("DB VERIFICATION FOR TAB - TC09");
		...
		Map<String, Object> apiOperation3 = GenericUtils.featureFileFailLoop_status(environment,"classpath:tests/RCMS/AdjustRewardBalance/AdjustRewardBalanceTC9.feature","apiDetailsStatus","200");
		Reporting.logReporter(Status.INFO,
		...
		/*** DB VALIDATION FOR TAB ***/
		Reporting.setNewGroupName("DB VERIFICATION FOR HWS - TC09");
