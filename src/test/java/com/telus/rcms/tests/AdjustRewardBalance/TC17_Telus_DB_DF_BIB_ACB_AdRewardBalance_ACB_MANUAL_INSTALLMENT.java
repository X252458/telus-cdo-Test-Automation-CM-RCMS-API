...
public class TC17_Telus_DB_DF_BIB_ACB_AdRewardBalance_ACB_MANUAL_INSTALLMENT  extends BaseTest {
	...
	@Test(groups = {"Loyalty_Management","Adjust_Reward_Balance","TC17_Telus_DB_DF_BIB_ACB_AdRewardBalance_ACB_MANUAL_INSTALLMENT","CompleteRegressionSuite"})
	...
	public void testMethod_Termination(ITestContext iTestContext) throws Exception {
		...
		Reporting.setNewGroupName("ADJUST REWARD BALANCE API CALL - DB+DF+BIB+ACB_ACB_MANUAL_INSTALLMENT");
		Reporting.logReporter(Status.INFO, "API Test Env is : [" + apiEnv + "]");
		
		System.setProperty("karate.itemType","ACTIVATIONBILLCREDIT");

		Map<String, Object> apiOperation2 = GenericUtils.featureFileFailLoop_status(environment,"classpath:tests/RCMS/AdjustRewardBalance/AdjustRewardBalanceTC17.feature","apiDetailsStatus","200");
		Reporting.logReporter(Status.INFO,
	...
	public void payloadAndDbCheck() throws SQLException, IOException {
		...
		GenericUtils.responseDBCheckAdjustRewardBalance(jsonString, balanceAmount, 4);
