@LSMS
Feature: TC02 Perform Activation for Koodo Subscriber with TAB+HWS

  @v1-0
  Scenario: Verify Activation Koodo Subscriber with TAB+HWS
    #Operation 1
    When def tc02ActivateKoodoTAB_HWS = call read(PATH_API_OPS+'Activation/callActivationTC2.feature')
    #Request
