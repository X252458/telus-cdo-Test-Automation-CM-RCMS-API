@Ignore
Feature: RCMS Activation API - Telus Subscriber with DB+DF+BIB+ACB+AF
  ...
  Background: Configuration - Set up the authentication, Headers, and params
    ...
    * def payload = read(PATH_API_PAYLOAD + 'Activation/Others/Activation_DB_DF_BIB_ACB_AF.json')
