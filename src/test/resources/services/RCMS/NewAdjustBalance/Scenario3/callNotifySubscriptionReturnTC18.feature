@Ignore
Feature: RCMS New Adjust Reward Amount API -TC18 Perform Device Return – notifySubscriptionReturn which makes DF=0 
...
Background: Configuration - Set up the authentication, Headers, and params
    ...
    * def payload = read(PATH_API_PAYLOAD + 'NewAdjustBalance/Scenario3/TC18_Telus_DF_AF_NotifySubscriptionReturn.json')
