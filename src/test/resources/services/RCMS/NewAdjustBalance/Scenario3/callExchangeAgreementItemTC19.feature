@Ignore
Feature: RCMS New Adjust Reward Amount API - TC19 Perform Accessory Partial Return = ExchangeAgreementItem with amount=100 ( keep 200 dollar Accessory)
...
Background: Configuration - Set up the authentication, Headers, and params
    ...
    * def payload = read(PATH_API_PAYLOAD + 'NewAdjustBalance/Scenario3/TC19_Telus_DF_AF_ExchangeAgreementItem.json')
