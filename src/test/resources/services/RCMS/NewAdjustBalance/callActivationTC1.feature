@Ignore
Feature: RCMS Activation API -Activate Telus Subscriber with DF+ACCESSORYFINANCE
  ...
  Background: Configuration - Set up the authentication, Headers, and params
    ...
    * def payload = read(PATH_API_PAYLOAD + 'NewAdjustBalance/RCMS_Activate_DF_AF.json')
