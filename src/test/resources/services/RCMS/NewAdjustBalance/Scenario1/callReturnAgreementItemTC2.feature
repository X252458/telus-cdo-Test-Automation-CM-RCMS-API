@Ignore
Feature: RCMS New Adjust Reward Amount API - TC02 Perform Accessory return - ReturnAgreementItem with amount=300. (full amount)
...
Background: Configuration - Set up the authentication, Headers, and params
    ...
    * def payload = read(PATH_API_PAYLOAD + 'NewAdjustBalance/Scenario1/TC02_Telus_DF_AF_ReturnAgreementItem.json')
