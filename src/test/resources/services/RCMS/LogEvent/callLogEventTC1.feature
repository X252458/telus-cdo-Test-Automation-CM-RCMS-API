@Ignore
Feature: RCMS Log Event API - TC01 Telus Subscriber having DB+DF+BIB renewed to DB using Payment Method BIB_TELUS_PENDING_ LOG Event_RETURN_COMPLETE when device is received in good condition
